...
function SponsorPage() {
  return <SiteShell>
    <section className="relative min-h-[75svh] overflow-hidden bg-brand-purple text-primary-foreground"><img src={festivalMedia.heroCrowd} alt="Público e palco do Festival Aviva Cultura" className="absolute inset-0 size-full object-cover" /><div className="absolute inset-0 bg-brand-purple/60" /><div className="absolute inset-x-0 bottom-0 h-4/5 bg-gradient-to-t from-brand-purple to-transparent" /><div className="relative mx-auto flex min-h-[75svh] max-w-7xl items-end px-5 py-14 md:px-8 md:py-20"><div className="max-w-5xl"><p className="text-sm font-bold uppercase text-brand-yellow">Patrocínio</p><h1 className="mt-4 font-display text-4xl uppercase leading-tight md:text-7xl">Transforme impostos em impacto social: Seja um patrocinador do Festival Aviva Cultura</h1><p className="mt-6 max-w-4xl text-lg leading-relaxed text-primary-foreground/85 md:text-xl">Sua marca tem o poder de levar arte, inspiração e vida para o coração das nossas cidades. Ao patrocinar o Festival Aviva Cultura, você não apenas associa sua empresa a um projeto de sucesso consolidado, mas se torna um agente direto de transformação sociocultural, democratizando o acesso à cultura e fomentando a economia criativa local.</p></div></div></section>
